...
func (s *Storage) createLink(ctx context.Context, path string, target string, opt pairStorageCreateLink) (o *Object, err error) {
	...
	input := &service.PutObjectInput{
		...
		// ref: https://github.com/minhjh/go-service-qingstor/blob/master/rfcs/79-add-virtual-link-support.md
...
func (s *Storage) list(ctx context.Context, path string, opt pairStorageList) (oi *ObjectIterator, err error) {
	...
	if !opt.HasListMode {
		...
		// ref: [GSP-654](https://github.com/minhjh/go-storage/blob/master/docs/rfcs/654-unify-list-behavior.md)
